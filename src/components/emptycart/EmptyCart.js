...
function EmptyCart() {
  return (
    <div className="empty-cart-container">
                    ...
                    <div className="col-sm-12 empty-cart-cls text-center"> <img src="https://i.pinimg.com/originals/14/00/86/140086055190b3005647dd397c01e071.png" width="130" height="130" className="img-fluid mb-4 mr-3"/>
